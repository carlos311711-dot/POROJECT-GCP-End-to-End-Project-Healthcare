...
COMPOSER_BUCKET = "us-central1-demo-instance-a649b781-bucket" ## cambiar esto
...
with DAG(
    ...
    description="DAG para iniciar un clúster de Dataproc, ejecutar los jobs de PySpark y detener el clúster",
    default_args=ARGS,
